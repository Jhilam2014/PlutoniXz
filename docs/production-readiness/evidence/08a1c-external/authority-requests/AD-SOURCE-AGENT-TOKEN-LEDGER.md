# Authority request — AD-SOURCE-AGENT-TOKEN-LEDGER

Status: **PENDING_SOURCE_OWNER_IDENTIFICATION**. Created from sanitized repository provenance at 2026-08-11T21:51:32Z.

## Scope

- Source scope: `SOURCE_SCOPE_AGENT_TOKEN_LEDGER`
- Source-system/root boundary: `database/agent-token-usage.table.jsonl`
- Residual logical items: 2
