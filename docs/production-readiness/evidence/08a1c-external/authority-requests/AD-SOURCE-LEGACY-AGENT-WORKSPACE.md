# Authority request — AD-SOURCE-LEGACY-AGENT-WORKSPACE

Status: **PENDING_SOURCE_OWNER_IDENTIFICATION**. Created from sanitized repository provenance at 2026-08-11T21:51:32Z.

## Scope

- Source scope: `SOURCE_SCOPE_LEGACY_AGENT_WORKSPACE`
- Source-system/root boundary: `newAgent/`
- Residual logical items: 1
