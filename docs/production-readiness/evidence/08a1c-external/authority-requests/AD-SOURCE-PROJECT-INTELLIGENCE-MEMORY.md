# Authority request — AD-SOURCE-PROJECT-INTELLIGENCE-MEMORY

Status: **PENDING_SOURCE_OWNER_IDENTIFICATION**. Created from sanitized repository provenance at 2026-08-11T21:51:32Z.

## Scope

- Source scope: `SOURCE_SCOPE_PROJECT_INTELLIGENCE_MEMORY`
- Source-system/root boundary: `memory/project-intelligence/projects/`
- Residual logical items: 12
