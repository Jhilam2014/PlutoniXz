...
| generic-api-key | Broad key/value string shape; it makes no secret, provider, or authentication-semantic assertion. | BROAD_STRING_SHAPE_ONLY | NO_GENERIC_CREDENTIAL_PARSER | 1045 | 0 | 13 | 1058 | 14917 | Require a source schema that marks the field secret-bearing and a privileged-use consumption trace. |
