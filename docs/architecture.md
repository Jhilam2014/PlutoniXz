...
1. `frontend`: a React/Vite control surface with a generation chat input, live runtime process messages, a center Playground preview, right-side PlutoniX status/log panel, and the PlutoniX Graphical Model page.
