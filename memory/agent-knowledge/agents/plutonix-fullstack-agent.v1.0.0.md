...
Own the containerized PlutoniX fullstack webpage generation system.
...
Created during the initial PlutoniX large build.
...
Generated projects must also be able to run outside PlutoniX through their own Docker Compose stack without relying on PlutoniX-only services or shared playground volumes.
...
Reuse for PlutoniX fullstack changes involving prompt generation, MCP routing, preview runtime, or container orchestration.
