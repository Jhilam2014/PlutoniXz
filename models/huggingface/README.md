# PlutoMix Hugging Face Models

This is the PlutoMix-local Hugging Face model workspace.

Use this folder whenever PlutoMix itself requires a Hugging Face model for self-improvement, small local tasks, or generated-project support:
...
When a model is added or downloaded, PlutoMix estimates the Hugging Face repository size and records it as `sizeGb`/`sizeLabel` in the manifest and service metadata.
