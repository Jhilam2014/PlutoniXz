...
import { evaluateSemanticEvidence, noCandidateBearingData, ruleSemanticsFor } from './08a1b-r3-semantic-lib.mjs';
...
for (const value of [generatedId, genericLike, providerLike, environmentCandidate, environmentBuffer]) value.fill(0);
console.log('08A1B-R3 semantic parser, controlled-environment context, contextual-positive, unresolved, rule-contract, and non-disclosure tests passed.');
