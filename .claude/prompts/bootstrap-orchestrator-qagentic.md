Optional new-project bootstrap prompt for QAgentic support in Claude/Claude Code.
...
- Do not replace AGENTS.md, CLAUDE.md, or any existing orchestrator instruction.
...
- Create `.claude/prompts/task-qagentic.md` if missing.
