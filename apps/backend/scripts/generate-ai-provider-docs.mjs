...
- **Claude authentication required:** open **AI Accounts**, reconnect the isolated profile with browser sign-in or organization SSO, and run **Verify profile**. Do not paste authorization material into logs or tickets.
