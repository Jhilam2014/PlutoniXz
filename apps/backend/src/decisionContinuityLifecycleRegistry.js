...
export const DECISION_CONTINUITY_LIFECYCLE_ROUTES = Object.freeze({
  ...
  architecture_branch_discovery: { method: "post", path: "/projects/:projectId/architecture-branches", kind: "transactionally_synchronous", trust: "tenant_user", permission: "decision:propose", idempotency: "source-tree digest", matrix: { tenant: "identity", execution: "synchronous", fixture: "project", jsonBody: true }, tests: ["project architecture branch discovery"] },
  architecture_branch_list: { method: "get", path: "/projects/:projectId/architecture-branches", kind: "read_only", trust: "tenant_user", permission: "decision:read", matrix: { tenant: "identity", execution: "read", fixture: "project" }, tests: ["project architecture branch discovery"] },
